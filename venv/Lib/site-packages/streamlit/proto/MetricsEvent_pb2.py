...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_METRICSEVENT']._serialized_end=1055
  _globals['_BROWSERINFO']._serialized_start=1057
  _globals['_BROWSERINFO']._serialized_end=1150
